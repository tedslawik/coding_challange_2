...
WebDriver driver = GlobalConfig.setUp();
    public WebElement headerText(){
        ...
        return driver.findElement(By.cssSelector(".container > h3"));
    }
    public WebElement  searchDropDown() {
        return driver.findElement(By.cssSelector("#search-column"));
    }
    public WebElement searchDropDownOption(String optionSelector){
        return searchDropDown().findElement(By.cssSelector("option[value='"+optionSelector+"']"));
    }
    ...
    public WebElement searchSloganResult(){
        return  driver.findElement(By.cssSelector("#search-slogan"));
    }
